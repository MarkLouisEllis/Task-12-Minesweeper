This is a basic minesweeper aplication.

Here are the rules of the game if you are unfimiliar.
...
If you would like to run this app on your local machine follow these instudtions.

Open cmd terminal
Navigate to the directory of the app. Be sure to navigate to the "game" folder.
type npm install. 
type npm start
